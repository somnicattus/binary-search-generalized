...
export declare const ndBinarySearch: <D extends number, T>(alwaysEnd: ReadonlyVector<D, T>, neverEnd: ReadonlyVector<D, T>, predicate: (vector: ReadonlyVector<D, T>) => boolean, midpoint: FixedLengthArray<(always: T, never: T) => T, D>, shouldContinue: FixedLengthArray<(always: T, never: T) => boolean, D>) => Generator<Vector<D, T>, void, any>;
